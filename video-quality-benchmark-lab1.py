...
if __name__=="__main__":
    ...
    command = """docker exec dj2transcode2 bash -c 'dj2-transcode -hwaccel vaapi -hwaccel_output_format vaapi -vaapi_device /dev/dri/renderD128 \
...
-minrate 5500k \
-me_method full \
-c:a copy -f mp4 /data/xxx/xxx_1440p_10M_dj2_leo_test.mp4'""".format(vaapi_param_arr[0][0], vaapi_param_arr[0][1], vaapi_param_arr[0][2], vaapi_param_arr[0][3], vaapi_param_arr[0][4], vaapi_param_arr[0][5], vaapi_param_arr[0][6], vaapi_param_arr[0][7], vaapi_param_arr[0][8])
